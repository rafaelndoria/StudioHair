...
namespace StudioHair.Infrascruture.Migrations
{
    ...
    [Migration("20240914001715_AdicionadoVinculoEntreUsuarioEPessoa")]
    partial class AdicionadoVinculoEntreUsuarioEPessoa
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StudioHair.Core.Entities.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Ativo = true,
                            DataDeCadastro = new DateTime(2024, 9, 13, 21, 17, 13, 731, DateTimeKind.Local).AddTicks(9919),
